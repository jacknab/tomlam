/*
  # Fix SMS URL encoding and message tracking

  1. Changes
    - Update trigger function to properly encode tinyurl.com URL
    - Add URL validation in trigger function
...
BEGIN
  ...
  IF NEW.status = 'checked_out' AND 
    ...
    -- Insert new scheduled SMS record with properly encoded URL
    ...
    VALUES (
      ...
      'https://tinyurl.com/store' || NEW.storeid::text,
      NEW.storeid,

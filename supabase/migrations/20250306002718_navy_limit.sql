/*
  # Fix default store configuration

  1. Changes
    - Ensures default store with store_number 9001 exists
    - Updates store configuration with proper defaults
...
-- Insert or update the default store
INSERT INTO store (
  store_number,
  phone_number,
  pin,
